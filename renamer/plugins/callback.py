...
@RenamerSh.on_callback_query(filters.regex('^help$'))
...
@RenamerSh.on_callback_query(filters.regex('^donate$'))
...
@RenamerSh.on_callback_query(filters.regex('^close$'))
...
@RenamerSh.on_callback_query(filters.regex('^back$'))
...
@RenamerSh.on_callback_query(filters.regex('^about$'))
