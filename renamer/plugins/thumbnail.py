...
@RenamerSh.on_message(filters.photo & filters.incoming & filters.private)
...
@RenamerSh.on_message(filters.command("deletethumbnail") & filters.incoming & filters.private)
...
@RenamerSh.on_message(filters.command("showthumbnail") & filters.incoming & filters.private)
